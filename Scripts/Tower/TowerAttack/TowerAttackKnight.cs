...
[CreateAssetMenu(fileName = "TowerAttackKnight", menuName = "Scriptable Objects/Tower/TowerAttackKnight")]
public class TowerAttackKnight : TowerAttackType
{
    ...
    public override void TowerAttack(Tower tower)
    {
        ...
        Vector3 localOffset = Vector3.right * 1.5f;
        ...
        SoundEffectManager.Instance.PlaySoundEffect(ESoundEffectType.KnightAttack);
